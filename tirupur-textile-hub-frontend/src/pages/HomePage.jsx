    ...
    <div className="space-y-12">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 relative h-[400px] rounded-3xl overflow-hidden group">
          <img 
            src="https://images.unsplash.com/photo-1558278226-9fa105821c7a?auto=format&fit=crop&q=80&w=1200" 
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { name: 'Knitted T-Shirts', count: '1.2k+ items', icon: 'checkroom' },
            { name: 'Organic Fabrics', count: '850+ items', icon: 'eco' },
            { name: 'Sportswear', count: '600+ items', icon: 'fitness_center' },
            { name: 'Infant Wear', count: '450+ items', icon: 'child_care' },
          ].map((cat) => (
            <div key={cat.name} className="bg-white p-6 rounded-2xl border border-slate-50 shadow-soft hover:shadow-hover transition-all cursor-pointer group">
