...
2. **`STRIX_LLM`** (Optional): The identifier for the LLM provider and model (e.g. `gemini/gemini-2.5-flash` or `openai/gpt-4o`). If not provided, it defaults to `gemini/gemini-2.5-flash`.
